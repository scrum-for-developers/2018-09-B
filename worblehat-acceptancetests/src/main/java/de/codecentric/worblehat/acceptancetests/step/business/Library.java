...
public class Library {
	...
	public void createLibraryWithSingleBookWithGivenIsbn(String isbn) {
		...
		bookService.createBook(book.getTitle(), book.getAuthor(), book.getEdition(), isbn, book.getYearOfPublication(), book.getDescription());
	}

	// just an example of how a step looks that is different from another one, after
	// the last parameter
